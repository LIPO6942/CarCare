...
const CategorizeRepairOutputSchema = z.object({
  category: z
    .string()
    .describe(
      'The categorized type of repair (e.g., Moteur, Freins, Électrique, Suspension, Carrosserie, Intérieur, Échappement, Transmission, Pneus, Autre).'
    ),
});
...
const categorizeRepairPrompt = ai.definePrompt({
  ...
  prompt: `You are an expert automotive technician. Please categorize the following car repair details into one of the following categories: Moteur, Freins, Électrique, Suspension, Carrosserie, Intérieur, Échappement, Transmission, Pneus, Autre. Only respond with the category. 
