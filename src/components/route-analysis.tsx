...
export function RouteAnalysis({ vehicleId }: { vehicleId: string }) {
    ...
    const stats = useMemo(() => {
        ...
        patterns.forEach(p => {
            ...
            byType[type].count++;
            byType[type].totalCons += p.consumption; // Sum of L/100km (not quite right for avg, need to weigh)
    ...
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Derniers Trajets Analysés</CardTitle>
                        <CardDescription>Basé sur vos intervalles de pleins</CardDescription>
                    </CardHeader>
                    <CardContent>
